...
class RuboCop::Cop::AmbiguousCopName < ::RuboCop::Error
  # source://rubocop/1.59.0/lib/rubocop/cop/registry.rb#11
...
class RuboCop::Cop::RSpecRails::AvoidSetupHook < ::RuboCop::Cop::RSpec::Base
...
class RuboCop::Cop::RSpecRails::HttpStatus < ::RuboCop::Cop::RSpec::Base
...
class RuboCop::Cop::RSpecRails::MinitestAssertions < ::RuboCop::Cop::RSpec::Base
  extend ::RuboCop::Cop::AutoCorrector
...
class RuboCop::Cop::RSpecRails::NegationBeValid < ::RuboCop::Cop::RSpec::Base
  include ::RuboCop::Cop::ConfigurableEnforcedStyle
  extend ::RuboCop::Cop::AutoCorrector
...
class RuboCop::Cop::RSpecRails::TravelAround < ::RuboCop::Cop::RSpec::Base
  extend ::RuboCop::Cop::AutoCorrector
