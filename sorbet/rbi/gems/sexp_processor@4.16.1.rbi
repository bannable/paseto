...
class Object < ::BasicObject
  ...
  # source://sexp_processor//lib/sexp.rb#385
  def s(*args, &blk); end
end
...
class Sexp < ::Array
  ...
  #
  # source://sexp_processor//lib/sexp.rb#30
  ...
  # source://sexp_processor//lib/sexp.rb#70
  def ==(obj); end
  ...
  # @return [Boolean]
  #
  # source://sexp_processor//lib/sexp.rb#87
  def array_type?; end
  ...
  #   end
  #
  # source://sexp_processor//lib/sexp.rb#107
  def deep_each(&block); end

  # Return the maximum depth of the sexp. One-based.
  #
  # source://sexp_processor//lib/sexp.rb#119
  def depth; end

  # Enumeratates the sexp yielding to +b+ when the node_type == +t+.
  #
  # source://sexp_processor//lib/sexp.rb#126
  def each_of_type(t, &b); end

  # Enumerates all sub-sexps skipping non-Sexp elements.
  #
  # source://sexp_processor//lib/sexp.rb#138
  def each_sexp; end

  # @return [Boolean]
  #
  # source://sexp_processor//lib/sexp.rb#74
  def eql?(o); end
  ...
  #
  # source://sexp_processor//lib/sexp.rb#152
  def find_and_replace_all(from, to); end

  # source://sexp_processor//lib/sexp.rb#193
  def find_node(name, delete = T.unsafe(nil)); end

  # Find every node with type +name+.
  #
  # source://sexp_processor//lib/sexp.rb#211
  def find_nodes(name); end

  # Replaces all Sexps matching +pattern+ with Sexp +repl+.
  #
  # source://sexp_processor//lib/sexp.rb#165
  def gsub(pattern, repl); end

  # source://flay/2.13.0/lib/flay.rb#603
  def has_code?; end

  # source://sexp_processor//lib/sexp.rb#78
  def hash; end

  # Returns the node type of the Sexp.
  #
  # source://sexp_processor//lib/sexp.rb#278
  def head; end

  # source://sexp_processor//lib/sexp.rb#184
  def inspect; end
  ...
  #
  # source://sexp_processor//lib/sexp.rb#222
  ...
  #
  # source://sexp_processor//lib/sexp.rb#58
  def new(*body); end
  ...
  # source://sexp_processor//lib/sexp.rb#266
  ...
  # @return [Boolean]
  #
  # source://sexp_processor//lib/sexp.rb#261
  ...
  #
  # source://sexp_processor//lib/sexp.rb#293
  ...
  #
  # source://sexp_processor//lib/sexp.rb#300
  def sexp_body=(v); end
  ...
  #
  # source://sexp_processor//lib/sexp.rb#285
  def sexp_type=(v); end
  ...
  #
  # source://sexp_processor//lib/sexp.rb#320
  def structure; end

  # Replaces the Sexp matching +pattern+ with +repl+.
  #
  # source://sexp_processor//lib/sexp.rb#332
  def sub(pattern, repl); end

  # source://sexp_processor//lib/sexp.rb#362
  def to_a; end
  ...
  #
  # source://sexp_processor//lib/sexp.rb#371
  def value; end
...
# source://sexp_processor//lib/sexp.rb#215
