...
# NaCl/libsodium for Ruby
#
# pkg:gem/rbnacl#lib/rbnacl/version.rb:5
module RbNaCl; end

# pkg:gem/rbnacl#lib/rbnacl/aead/base.rb:5
...
#
# pkg:gem/rbnacl#lib/rbnacl/aead/base.rb:13
class RbNaCl::AEAD::Base
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/aead/base.rb:32
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/aead/base.rb:68
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/aead/base.rb:46
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/aead/base.rb:111
  def key_bytes; end
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/aead/base.rb:97
  def nonce_bytes; end
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/aead/base.rb:83
  def primitive; end
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/aead/base.rb:125
  def tag_bytes; end

  private

  # pkg:gem/rbnacl#lib/rbnacl/aead/base.rb:131
  def data_len(data); end

  # pkg:gem/rbnacl#lib/rbnacl/aead/base.rb:141
  def do_decrypt(_message, _message_len, _nonce, _ciphertext, _additional_data); end

  # pkg:gem/rbnacl#lib/rbnacl/aead/base.rb:137
  def do_encrypt(_ciphertext, _ciphertext_len, _nonce, _message, _additional_data); end

  # pkg:gem/rbnacl#lib/rbnacl/aead/base.rb:20
  def key; end
  ...
  class << self
    ...
    # @return [Integer] The number of bytes in a valid key
    #
    # pkg:gem/rbnacl#lib/rbnacl/aead/base.rb:104
    def key_bytes; end
    ...
    # @return [Integer] The number of bytes in a valid nonce
    #
    # pkg:gem/rbnacl#lib/rbnacl/aead/base.rb:90
    def nonce_bytes; end
    ...
    # @return [Integer] number of tag bytes
    #
    # pkg:gem/rbnacl#lib/rbnacl/aead/base.rb:118
    def tag_bytes; end
  end
end
...
#
# pkg:gem/rbnacl#lib/rbnacl/aead/chacha20poly1305_ietf.rb:8
class RbNaCl::AEAD::ChaCha20Poly1305IETF < ::RbNaCl::AEAD::Base
  extend ::RbNaCl::Sodium
  extend ::FFI::Library

  # pkg:gem/rbnacl#lib/rbnacl/aead/chacha20poly1305_ietf.rb:16
  def crypto_aead_chacha20poly1305_ietf_abytes(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/aead/chacha20poly1305_ietf.rb:22
  def crypto_aead_chacha20poly1305_ietf_decrypt(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/aead/chacha20poly1305_ietf.rb:18
  def crypto_aead_chacha20poly1305_ietf_encrypt(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/aead/chacha20poly1305_ietf.rb:14
  def crypto_aead_chacha20poly1305_ietf_keybytes(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/aead/chacha20poly1305_ietf.rb:15
  def crypto_aead_chacha20poly1305_ietf_npubbytes(*_arg0); end

  private

  # pkg:gem/rbnacl#lib/rbnacl/aead/chacha20poly1305_ietf.rb:35
  def do_decrypt(message, message_len, nonce, ciphertext, additional_data); end

  # pkg:gem/rbnacl#lib/rbnacl/aead/chacha20poly1305_ietf.rb:28
...
# pkg:gem/rbnacl#lib/rbnacl/sodium.rb:44
...
# Authenticated Encryption with Additional Data using ChaCha20-Poly1305
#
# pkg:gem/rbnacl#lib/rbnacl/aead/chacha20poly1305_legacy.rb:8
class RbNaCl::AEAD::ChaCha20Poly1305Legacy < ::RbNaCl::AEAD::Base
  extend ::RbNaCl::Sodium
  extend ::FFI::Library

  # pkg:gem/rbnacl#lib/rbnacl/aead/chacha20poly1305_legacy.rb:15
  def crypto_aead_chacha20poly1305_abytes(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/aead/chacha20poly1305_legacy.rb:21
  def crypto_aead_chacha20poly1305_decrypt(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/aead/chacha20poly1305_legacy.rb:17
  def crypto_aead_chacha20poly1305_encrypt(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/aead/chacha20poly1305_legacy.rb:13
  def crypto_aead_chacha20poly1305_keybytes(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/aead/chacha20poly1305_legacy.rb:14
  def crypto_aead_chacha20poly1305_npubbytes(*_arg0); end

  private

  # pkg:gem/rbnacl#lib/rbnacl/aead/chacha20poly1305_legacy.rb:34
  def do_decrypt(message, message_len, nonce, ciphertext, additional_data); end

  # pkg:gem/rbnacl#lib/rbnacl/aead/chacha20poly1305_legacy.rb:27
  def do_encrypt(ciphertext, ciphertext_len, nonce, message, additional_data); end
...
# Authenticated Encryption with Additional Data using ChaCha20-Poly1305
#
# pkg:gem/rbnacl#lib/rbnacl/aead/xchacha20poly1305_ietf.rb:8
class RbNaCl::AEAD::XChaCha20Poly1305IETF < ::RbNaCl::AEAD::Base
  extend ::RbNaCl::Sodium
  extend ::FFI::Library

  # pkg:gem/rbnacl#lib/rbnacl/aead/xchacha20poly1305_ietf.rb:16
  def crypto_aead_xchacha20poly1305_ietf_abytes(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/aead/xchacha20poly1305_ietf.rb:22
  def crypto_aead_xchacha20poly1305_ietf_decrypt(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/aead/xchacha20poly1305_ietf.rb:18
  def crypto_aead_xchacha20poly1305_ietf_encrypt(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/aead/xchacha20poly1305_ietf.rb:14
  def crypto_aead_xchacha20poly1305_ietf_keybytes(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/aead/xchacha20poly1305_ietf.rb:15
  def crypto_aead_xchacha20poly1305_ietf_npubbytes(*_arg0); end

  private

  # pkg:gem/rbnacl#lib/rbnacl/aead/xchacha20poly1305_ietf.rb:35
  def do_decrypt(message, message_len, nonce, ciphertext, additional_data); end

  # pkg:gem/rbnacl#lib/rbnacl/aead/xchacha20poly1305_ietf.rb:28
  def do_encrypt(ciphertext, ciphertext_len, nonce, message, additional_data); end
...
class RbNaCl::Auth
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/auth.rb:56
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/auth.rb:95
  def key_bytes; end
  ...
  # @return [Symbol] The primitive used
  #
  # pkg:gem/rbnacl#lib/rbnacl/auth.rb:81
  def primitive; end
  ...
  # @return [Integer] number of tag bytes
  #
  # pkg:gem/rbnacl#lib/rbnacl/auth.rb:109
  def tag_bytes; end
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/auth.rb:72
  def verify(authenticator, message); end

  private

  # pkg:gem/rbnacl#lib/rbnacl/auth.rb:115
  def compute_authenticator(_authenticator, _message); end

  # pkg:gem/rbnacl#lib/rbnacl/auth.rb:17
  def key; end

  # pkg:gem/rbnacl#lib/rbnacl/auth.rb:119
  ...
  class << self
    ...
    # @return [String] The authenticator, as raw bytes
    #
    # pkg:gem/rbnacl#lib/rbnacl/auth.rb:33
    ...
    # @return [Integer] number of key bytes
    #
    # pkg:gem/rbnacl#lib/rbnacl/auth.rb:88
    def key_bytes; end
    ...
    # @return [Integer] number of tag bytes
    #
    # pkg:gem/rbnacl#lib/rbnacl/auth.rb:102
    def tag_bytes; end
    ...
    # @return [Boolean] Was it valid?
    #
    # pkg:gem/rbnacl#lib/rbnacl/auth.rb:47
...
#
# pkg:gem/rbnacl#lib/rbnacl/boxes/curve25519xsalsa20poly1305.rb:66
class RbNaCl::Boxes::Curve25519XSalsa20Poly1305
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/boxes/curve25519xsalsa20poly1305.rb:101
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/boxes/curve25519xsalsa20poly1305.rb:121
  def box(nonce, message); end

  # pkg:gem/rbnacl#lib/rbnacl/boxes/curve25519xsalsa20poly1305.rb:86
  def crypto_box_curve25519xsalsa20poly1305_afternm(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/boxes/curve25519xsalsa20poly1305.rb:78
  def crypto_box_curve25519xsalsa20poly1305_beforenm(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/boxes/curve25519xsalsa20poly1305.rb:74
  def crypto_box_curve25519xsalsa20poly1305_beforenmbytes(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/boxes/curve25519xsalsa20poly1305.rb:73
  def crypto_box_curve25519xsalsa20poly1305_boxzerobytes(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/boxes/curve25519xsalsa20poly1305.rb:71
  def crypto_box_curve25519xsalsa20poly1305_noncebytes(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/boxes/curve25519xsalsa20poly1305.rb:82
  def crypto_box_curve25519xsalsa20poly1305_open_afternm(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/boxes/curve25519xsalsa20poly1305.rb:75
  def crypto_box_curve25519xsalsa20poly1305_publickeybytes(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/boxes/curve25519xsalsa20poly1305.rb:76
  def crypto_box_curve25519xsalsa20poly1305_secretkeybytes(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/boxes/curve25519xsalsa20poly1305.rb:72
  def crypto_box_curve25519xsalsa20poly1305_zerobytes(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/boxes/curve25519xsalsa20poly1305.rb:157
  def decrypt(nonce, ciphertext); end

  # pkg:gem/rbnacl#lib/rbnacl/boxes/curve25519xsalsa20poly1305.rb:131
  ...
  # @return [Integer] The number of bytes in a valid nonce
  #
  # pkg:gem/rbnacl#lib/rbnacl/boxes/curve25519xsalsa20poly1305.rb:176
  def nonce_bytes; end
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/boxes/curve25519xsalsa20poly1305.rb:147
  ...
  # @return [Symbol] The primitive used
  #
  # pkg:gem/rbnacl#lib/rbnacl/boxes/curve25519xsalsa20poly1305.rb:162
  def primitive; end

  private

  # pkg:gem/rbnacl#lib/rbnacl/boxes/curve25519xsalsa20poly1305.rb:182
  def beforenm; end
  ...
  class << self
    ...
    # @return [Integer] The number of bytes in a valid nonce
    #
    # pkg:gem/rbnacl#lib/rbnacl/boxes/curve25519xsalsa20poly1305.rb:169
    def nonce_bytes; end
  end
end
...
#
# pkg:gem/rbnacl#lib/rbnacl/boxes/curve25519xsalsa20poly1305/private_key.rb:16
class RbNaCl::Boxes::Curve25519XSalsa20Poly1305::PrivateKey
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/boxes/curve25519xsalsa20poly1305/private_key.rb:44
  def initialize(private_key); end

  # pkg:gem/rbnacl#lib/rbnacl/boxes/curve25519xsalsa20poly1305/private_key.rb:25
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/boxes/curve25519xsalsa20poly1305/private_key.rb:77
  def primitive; end
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/boxes/curve25519xsalsa20poly1305/private_key.rb:70
  def public_key; end
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/boxes/curve25519xsalsa20poly1305/private_key.rb:63
  def to_bytes; end
  ...
  class << self
    ...
    #
    # pkg:gem/rbnacl#lib/rbnacl/boxes/curve25519xsalsa20poly1305/private_key.rb:53
    def generate; end
  end
end
...
#
# pkg:gem/rbnacl#lib/rbnacl/boxes/curve25519xsalsa20poly1305/private_key.rb:30
...
#
# pkg:gem/rbnacl#lib/rbnacl/boxes/curve25519xsalsa20poly1305/public_key.rb:11
class RbNaCl::Boxes::Curve25519XSalsa20Poly1305::PublicKey
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/boxes/curve25519xsalsa20poly1305/public_key.rb:29
  ...
  # @return [Symbol] The primitive
  #
  # pkg:gem/rbnacl#lib/rbnacl/boxes/curve25519xsalsa20poly1305/public_key.rb:50
  def primitive; end
  ...
  # @return [String] the raw bytes.
  #
  # pkg:gem/rbnacl#lib/rbnacl/boxes/curve25519xsalsa20poly1305/public_key.rb:36
  def to_bytes; end
  ...
  class << self
    ...
    # @return [Symbol] The primitive
    #
    # pkg:gem/rbnacl#lib/rbnacl/boxes/curve25519xsalsa20poly1305/public_key.rb:43
    def primitive; end
  end
end
...
# The size of the key, in bytes
#
# pkg:gem/rbnacl#lib/rbnacl/boxes/curve25519xsalsa20poly1305/public_key.rb:16
...
#
# pkg:gem/rbnacl#lib/rbnacl/boxes/sealed.rb:19
class RbNaCl::Boxes::Sealed
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/boxes/sealed.rb:47
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/boxes/sealed.rb:92
  def box(message); end

  # pkg:gem/rbnacl#lib/rbnacl/boxes/sealed.rb:26
  def crypto_box_seal(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/boxes/sealed.rb:30
  def crypto_box_seal_open(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/boxes/sealed.rb:23
  def crypto_box_sealbytes(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/boxes/sealed.rb:126
  def decrypt(ciphertext); end

  # pkg:gem/rbnacl#lib/rbnacl/boxes/sealed.rb:103
  ...
  # @return [String] The decrypted message (BINARY encoded)
  #
  # pkg:gem/rbnacl#lib/rbnacl/boxes/sealed.rb:113
  ...
  # @return [Symbol] The primitive used
  #
  # pkg:gem/rbnacl#lib/rbnacl/boxes/sealed.rb:131
  def primitive; end
  ...
  class << self
    ...
    # @return [RbNaCl::SealedBox] The new Box, ready to use
    #
    # pkg:gem/rbnacl#lib/rbnacl/boxes/sealed.rb:68
    ...
    # @return [RbNaCl::SealedBox] The new Box, ready to use
    #
    # pkg:gem/rbnacl#lib/rbnacl/boxes/sealed.rb:81
...
#
# pkg:gem/rbnacl#lib/rbnacl.rb:30
class RbNaCl::CryptoError < ::StandardError; end

# pkg:gem/rbnacl#lib/rbnacl.rb:103
RbNaCl::GroupElement = RbNaCl::GroupElements::Curve25519

# pkg:gem/rbnacl#lib/rbnacl/group_elements/curve25519.rb:5
...
#
# pkg:gem/rbnacl#lib/rbnacl/group_elements/curve25519.rb:14
class RbNaCl::GroupElements::Curve25519
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/group_elements/curve25519.rb:47
  def initialize(point); end

  # pkg:gem/rbnacl#lib/rbnacl/group_elements/curve25519.rb:32
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/group_elements/curve25519.rb:64
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/group_elements/curve25519.rb:78
  def to_bytes; end
  ...
  class << self
    ...
    #
    # pkg:gem/rbnacl#lib/rbnacl/group_elements/curve25519.rb:87
    def base; end

    # pkg:gem/rbnacl#lib/rbnacl/group_elements/curve25519.rb:92
    def base_point; end
...
# pkg:gem/rbnacl#lib/rbnacl/group_elements/curve25519.rb:38
...
#
# pkg:gem/rbnacl#lib/rbnacl/group_elements/curve25519.rb:22
RbNaCl::GroupElements::Curve25519::DEGENERATE_KEY = T.let(T.unsafe(nil), String)

# Number of bytes in a scalar on this curve
#
# pkg:gem/rbnacl#lib/rbnacl/group_elements/curve25519.rb:37
...
#
# pkg:gem/rbnacl#lib/rbnacl/hmac/sha256.rb:17
class RbNaCl::HMAC::SHA256 < ::RbNaCl::Auth
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/hmac/sha256.rb:43
  def initialize(key); end

  # pkg:gem/rbnacl#lib/rbnacl/hmac/sha256.rb:22
  def crypto_auth_hmacsha256_bytes(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/hmac/sha256.rb:33
  def crypto_auth_hmacsha256_final(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/hmac/sha256.rb:25
  def crypto_auth_hmacsha256_init(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/hmac/sha256.rb:23
  def crypto_auth_hmacsha256_keybytes(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/hmac/sha256.rb:29
  ...
  # @return [String] The authenticator, as raw bytes
  #
  # pkg:gem/rbnacl#lib/rbnacl/hmac/sha256.rb:64
  def digest; end
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/hmac/sha256.rb:71
  def hexdigest; end
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/hmac/sha256.rb:54
  def update(message); end

  private

  # pkg:gem/rbnacl#lib/rbnacl/hmac/sha256.rb:77
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/hmac/sha256.rb:87
...
#
# pkg:gem/rbnacl#lib/rbnacl/hmac/sha256.rb:95
...
#
# pkg:gem/rbnacl#lib/rbnacl/hmac/sha256.rb:103
...
# @see http://nacl.cr.yp.to/auth.html
#
# pkg:gem/rbnacl#lib/rbnacl/hmac/sha512.rb:17
class RbNaCl::HMAC::SHA512 < ::RbNaCl::Auth
  ...
  # see https://tools.ietf.org/html/rfc2104#section-3
  #
  # pkg:gem/rbnacl#lib/rbnacl/hmac/sha512.rb:43
  def initialize(key); end

  # pkg:gem/rbnacl#lib/rbnacl/hmac/sha512.rb:22
  def crypto_auth_hmacsha512_bytes(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/hmac/sha512.rb:33
  def crypto_auth_hmacsha512_final(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/hmac/sha512.rb:25
  def crypto_auth_hmacsha512_init(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/hmac/sha512.rb:23
  def crypto_auth_hmacsha512_keybytes(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/hmac/sha512.rb:29
  ...
  # @return [String] The authenticator, as raw bytes
  #
  # pkg:gem/rbnacl#lib/rbnacl/hmac/sha512.rb:64
  def digest; end
  ...
  # @return [String] The authenticator, as hex string
  #
  # pkg:gem/rbnacl#lib/rbnacl/hmac/sha512.rb:71
  def hexdigest; end
  ...
  # @params [#to_str] message message to construct an authenticator for
  #
  # pkg:gem/rbnacl#lib/rbnacl/hmac/sha512.rb:54
  def update(message); end

  private

  # pkg:gem/rbnacl#lib/rbnacl/hmac/sha512.rb:77
  def compute_authenticator(authenticator, message); end
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/hmac/sha512.rb:87
  def verify_message(authenticator, message); end
...
# @see http://nacl.cr.yp.to/auth.html
#
# pkg:gem/rbnacl#lib/rbnacl/hmac/sha512256.rb:17
class RbNaCl::HMAC::SHA512256 < ::RbNaCl::Auth
  ...
  # see https://tools.ietf.org/html/rfc2104#section-3
  #
  # pkg:gem/rbnacl#lib/rbnacl/hmac/sha512256.rb:43
  def initialize(key); end

  # pkg:gem/rbnacl#lib/rbnacl/hmac/sha512256.rb:22
  def crypto_auth_hmacsha512256_bytes(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/hmac/sha512256.rb:33
  def crypto_auth_hmacsha512256_final(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/hmac/sha512256.rb:25
  def crypto_auth_hmacsha512256_init(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/hmac/sha512256.rb:23
  def crypto_auth_hmacsha512256_keybytes(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/hmac/sha512256.rb:29
  ...
  # @return [String] The authenticator, as raw bytes
  #
  # pkg:gem/rbnacl#lib/rbnacl/hmac/sha512256.rb:64
  def digest; end
  ...
  # @return [String] The authenticator, as hex string
  #
  # pkg:gem/rbnacl#lib/rbnacl/hmac/sha512256.rb:71
  def hexdigest; end
  ...
  # @params [#to_str] message message to construct an authenticator for
  #
  # pkg:gem/rbnacl#lib/rbnacl/hmac/sha512256.rb:54
  def update(message); end

  private

  # pkg:gem/rbnacl#lib/rbnacl/hmac/sha512256.rb:77
  def compute_authenticator(authenticator, message); end

  # pkg:gem/rbnacl#lib/rbnacl/hmac/sha512256.rb:85
  def verify_message(authenticator, message); end
...
#
# pkg:gem/rbnacl#lib/rbnacl/hmac/sha512256.rb:93
...
#
# pkg:gem/rbnacl#lib/rbnacl/hmac/sha512256.rb:101
...
#
# pkg:gem/rbnacl#lib/rbnacl/hmac/sha512.rb:95
class RbNaCl::HMAC::SHA512::SHA512State < ::FFI::Struct; end

# The crypto_hash_sha512_state struct representation
# ref: jedisct1/libsodium/src/libsodium/include/sodium/crypto_hash_sha512.h
#
# pkg:gem/rbnacl#lib/rbnacl/hmac/sha512.rb:103
...
#
# pkg:gem/rbnacl#lib/rbnacl/hash.rb:17
module RbNaCl::Hash
  class << self
    ...
    #
    # pkg:gem/rbnacl#lib/rbnacl/hash.rb:65
    ...
    #
    # pkg:gem/rbnacl#lib/rbnacl/hash.rb:27
    def sha256(data); end
    ...
    #
    # pkg:gem/rbnacl#lib/rbnacl/hash.rb:43
    def sha512(data); end
  end
end
...
# similar to HMAC
#
# pkg:gem/rbnacl#lib/rbnacl/hash/blake2b.rb:15
class RbNaCl::Hash::Blake2b
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/hash/blake2b.rb:127
  def initialize(opts = T.unsafe(nil)); end

  # pkg:gem/rbnacl#lib/rbnacl/hash/blake2b.rb:157
  def <<(message); end

  # pkg:gem/rbnacl#lib/rbnacl/hash/blake2b.rb:21
  def crypto_generichash_blake2b_bytes_max(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/hash/blake2b.rb:20
  def crypto_generichash_blake2b_bytes_min(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/hash/blake2b.rb:39
  def crypto_generichash_blake2b_final(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/hash/blake2b.rb:31
  def crypto_generichash_blake2b_init_salt_personal(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/hash/blake2b.rb:23
  def crypto_generichash_blake2b_keybytes_max(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/hash/blake2b.rb:22
  def crypto_generichash_blake2b_keybytes_min(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/hash/blake2b.rb:25
  def crypto_generichash_blake2b_personalbytes(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/hash/blake2b.rb:27
  def crypto_generichash_blake2b_salt_personal(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/hash/blake2b.rb:24
  def crypto_generichash_blake2b_saltbytes(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/hash/blake2b.rb:35
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/hash/blake2b.rb:152
  def update(message); end
  ...
  class << self
    ...
    # @return [String] Blake2b digest of the string as raw bytes
    #
    # pkg:gem/rbnacl#lib/rbnacl/hash/blake2b.rb:60
    ...
    # pkg:gem/rbnacl#lib/rbnacl/hash/blake2b.rb:109
    ...
    #
    # pkg:gem/rbnacl#lib/rbnacl/hash/blake2b.rb:82
...
# pkg:gem/rbnacl#lib/rbnacl/hash/blake2b.rb:43
RbNaCl::Hash::Blake2b::EMPTY_PERSONAL = T.let(T.unsafe(nil), String)

# pkg:gem/rbnacl#lib/rbnacl/hash/blake2b.rb:44
...
#
# pkg:gem/rbnacl#lib/rbnacl/hash/blake2b.rb:174
class RbNaCl::Hash::Blake2b::State < ::FFI::Struct; end

# Provides a binding for the SHA256 function in libsodium
#
# pkg:gem/rbnacl#lib/rbnacl/hash/sha256.rb:7
module RbNaCl::Hash::SHA256
  extend ::RbNaCl::Sodium
  extend ::FFI::Library

  # pkg:gem/rbnacl#lib/rbnacl/hash/sha256.rb:12
  def crypto_hash_sha256(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/hash/sha256.rb:11
...
#
# pkg:gem/rbnacl#lib/rbnacl/hash/sha512.rb:7
module RbNaCl::Hash::SHA512
  extend ::RbNaCl::Sodium
  extend ::FFI::Library

  # pkg:gem/rbnacl#lib/rbnacl/hash/sha512.rb:12
  def crypto_hash_sha512(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/hash/sha512.rb:11
...
#
# pkg:gem/rbnacl#lib/rbnacl.rb:42
class RbNaCl::IncorrectPrimitiveError < ::ArgumentError; end

# Defines the libsodium init function
#
# pkg:gem/rbnacl#lib/rbnacl/init.rb:6
module RbNaCl::Init
  extend ::FFI::Library

  # pkg:gem/rbnacl#lib/rbnacl/init.rb:10
...
#
# pkg:gem/rbnacl#lib/rbnacl/key_comparator.rb:9
module RbNaCl::KeyComparator
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/key_comparator.rb:19
  def <=>(other); end
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/key_comparator.rb:43
  def ==(other); end

  private

  # pkg:gem/rbnacl#lib/rbnacl/key_comparator.rb:56
...
#
# pkg:gem/rbnacl#lib/rbnacl.rb:36
class RbNaCl::LengthError < ::ArgumentError; end

# pkg:gem/rbnacl#lib/rbnacl.rb:104
RbNaCl::OneTimeAuth = RbNaCl::OneTimeAuths::Poly1305

# pkg:gem/rbnacl#lib/rbnacl/one_time_auths/poly1305.rb:5
...
#
# pkg:gem/rbnacl#lib/rbnacl/one_time_auths/poly1305.rb:22
class RbNaCl::OneTimeAuths::Poly1305 < ::RbNaCl::Auth
  extend ::RbNaCl::Sodium
  extend ::FFI::Library

  # pkg:gem/rbnacl#lib/rbnacl/one_time_auths/poly1305.rb:30
  def crypto_onetimeauth_poly1305(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/one_time_auths/poly1305.rb:27
  def crypto_onetimeauth_poly1305_bytes(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/one_time_auths/poly1305.rb:28
  def crypto_onetimeauth_poly1305_keybytes(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/one_time_auths/poly1305.rb:34
  def crypto_onetimeauth_poly1305_verify(*_arg0); end

  private

  # pkg:gem/rbnacl#lib/rbnacl/one_time_auths/poly1305.rb:40
  def compute_authenticator(authenticator, message); end

  # pkg:gem/rbnacl#lib/rbnacl/one_time_auths/poly1305.rb:44
  def verify_message(authenticator, message); end
...
#
# pkg:gem/rbnacl#lib/rbnacl/password_hash.rb:23
module RbNaCl::PasswordHash
  class << self
    ...
    #
    # pkg:gem/rbnacl#lib/rbnacl/password_hash.rb:52
    ...
    #
    # pkg:gem/rbnacl#lib/rbnacl/password_hash.rb:95
    ...
    #
    # pkg:gem/rbnacl#lib/rbnacl/password_hash.rb:105
    ...
    #
    # pkg:gem/rbnacl#lib/rbnacl/password_hash.rb:67
    ...
    #
    # pkg:gem/rbnacl#lib/rbnacl/password_hash.rb:82
    ...
    #
    # pkg:gem/rbnacl#lib/rbnacl/password_hash.rb:35
    def scrypt(password, salt, opslimit = T.unsafe(nil), memlimit = T.unsafe(nil), digest_size = T.unsafe(nil)); end

    protected

    # pkg:gem/rbnacl#lib/rbnacl/password_hash.rb:112
...
#
# pkg:gem/rbnacl#lib/rbnacl/password_hash/argon2.rb:12
class RbNaCl::PasswordHash::Argon2
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/password_hash/argon2.rb:95
  def initialize(opslimit, memlimit, digest_size = T.unsafe(nil)); end

  # pkg:gem/rbnacl#lib/rbnacl/password_hash/argon2.rb:37
  def crypto_pwhash(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/password_hash/argon2.rb:18
  def crypto_pwhash_alg_argon2i13(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/password_hash/argon2.rb:19
  def crypto_pwhash_alg_argon2id13(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/password_hash/argon2.rb:17
  def crypto_pwhash_alg_default(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/password_hash/argon2.rb:24
  def crypto_pwhash_memlimit_interactive(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/password_hash/argon2.rb:30
  def crypto_pwhash_memlimit_max(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/password_hash/argon2.rb:29
  def crypto_pwhash_memlimit_min(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/password_hash/argon2.rb:26
  def crypto_pwhash_memlimit_moderate(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/password_hash/argon2.rb:28
  def crypto_pwhash_memlimit_sensitive(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/password_hash/argon2.rb:23
  def crypto_pwhash_opslimit_interactive(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/password_hash/argon2.rb:32
  def crypto_pwhash_opslimit_max(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/password_hash/argon2.rb:31
  def crypto_pwhash_opslimit_min(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/password_hash/argon2.rb:25
  def crypto_pwhash_opslimit_moderate(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/password_hash/argon2.rb:27
  def crypto_pwhash_opslimit_sensitive(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/password_hash/argon2.rb:21
  def crypto_pwhash_saltbytes(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/password_hash/argon2.rb:43
  def crypto_pwhash_str(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/password_hash/argon2.rb:49
  def crypto_pwhash_str_verify(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/password_hash/argon2.rb:22
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/password_hash/argon2.rb:111
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/password_hash/argon2.rb:143
  ...
  class << self
    ...
    #
    # pkg:gem/rbnacl#lib/rbnacl/password_hash/argon2.rb:215
    ...
    #
    # pkg:gem/rbnacl#lib/rbnacl/password_hash/argon2.rb:164
    ...
    #
    # pkg:gem/rbnacl#lib/rbnacl/password_hash/argon2.rb:199
    ...
    #
    # pkg:gem/rbnacl#lib/rbnacl/password_hash/argon2.rb:181
...
# pkg:gem/rbnacl#lib/rbnacl/password_hash/argon2.rb:35
RbNaCl::PasswordHash::Argon2::ARGON2_MAX_OUTLEN = T.let(T.unsafe(nil), Integer)

# pkg:gem/rbnacl#lib/rbnacl/password_hash/argon2.rb:34
RbNaCl::PasswordHash::Argon2::ARGON2_MIN_OUTLEN = T.let(T.unsafe(nil), Integer)

# pkg:gem/rbnacl#lib/rbnacl/password_hash/argon2.rb:55
...
#
# pkg:gem/rbnacl#lib/rbnacl/password_hash/scrypt.rb:20
class RbNaCl::PasswordHash::SCrypt
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/password_hash/scrypt.rb:39
  def initialize(opslimit, memlimit, digest_size = T.unsafe(nil)); end

  # pkg:gem/rbnacl#lib/rbnacl/password_hash/scrypt.rb:29
  def crypto_pwhash_scryptsalsa208sha256(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/password_hash/scrypt.rb:27
  def crypto_pwhash_scryptsalsa208sha256_memlimit_sensitive(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/password_hash/scrypt.rb:26
  def crypto_pwhash_scryptsalsa208sha256_opslimit_sensitive(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/password_hash/scrypt.rb:25
  ...
  # @return [String] scrypt digest of the string as raw bytes
  #
  # pkg:gem/rbnacl#lib/rbnacl/password_hash/scrypt.rb:57
...
# pkg:gem/rbnacl#lib/rbnacl/sodium.rb:44
RbNaCl::PasswordHash::SCrypt::MEMLIMIT_SENSITIVE = T.let(T.unsafe(nil), Integer)

# pkg:gem/rbnacl#lib/rbnacl/sodium.rb:44
RbNaCl::PasswordHash::SCrypt::OPSLIMIT_SENSITIVE = T.let(T.unsafe(nil), Integer)

# pkg:gem/rbnacl#lib/rbnacl/sodium.rb:44
RbNaCl::PasswordHash::SCrypt::SALTBYTES = T.let(T.unsafe(nil), Integer)

# pkg:gem/rbnacl#lib/rbnacl.rb:97
RbNaCl::PrivateKey = RbNaCl::Boxes::Curve25519XSalsa20Poly1305::PrivateKey

# pkg:gem/rbnacl#lib/rbnacl.rb:98
...
#
# pkg:gem/rbnacl#lib/rbnacl/random.rb:9
module RbNaCl::Random
  extend ::RbNaCl::Sodium
  extend ::FFI::Library

  # pkg:gem/rbnacl#lib/rbnacl/random.rb:14
  ...
  class << self
    ...
    #
    # pkg:gem/rbnacl#lib/rbnacl/random.rb:23
...
#
# pkg:gem/rbnacl#lib/rbnacl/simple_box.rb:116
RbNaCl::RandomNonceBox = RbNaCl::SimpleBox

# pkg:gem/rbnacl#lib/rbnacl.rb:99
RbNaCl::SealedBox = RbNaCl::Boxes::Sealed

# pkg:gem/rbnacl#lib/rbnacl.rb:100
RbNaCl::SecretBox = RbNaCl::SecretBoxes::XSalsa20Poly1305

# pkg:gem/rbnacl#lib/rbnacl/secret_boxes/xsalsa20poly1305.rb:5
...
# non-repudiable messages, sign them before or after encryption.
#
# pkg:gem/rbnacl#lib/rbnacl/secret_boxes/xsalsa20poly1305.rb:22
class RbNaCl::SecretBoxes::XSalsa20Poly1305
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/secret_boxes/xsalsa20poly1305.rb:49
  def initialize(key); end
  ...
  # @return [String] The ciphertext without the nonce prepended (BINARY encoded)
  #
  # pkg:gem/rbnacl#lib/rbnacl/secret_boxes/xsalsa20poly1305.rb:67
  def box(nonce, message); end

  # pkg:gem/rbnacl#lib/rbnacl/secret_boxes/xsalsa20poly1305.rb:32
  def crypto_secretbox_xsalsa20poly1305(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/secret_boxes/xsalsa20poly1305.rb:30
  def crypto_secretbox_xsalsa20poly1305_boxzerobytes(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/secret_boxes/xsalsa20poly1305.rb:27
  def crypto_secretbox_xsalsa20poly1305_keybytes(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/secret_boxes/xsalsa20poly1305.rb:28
  def crypto_secretbox_xsalsa20poly1305_noncebytes(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/secret_boxes/xsalsa20poly1305.rb:36
  def crypto_secretbox_xsalsa20poly1305_open(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/secret_boxes/xsalsa20poly1305.rb:29
  def crypto_secretbox_xsalsa20poly1305_zerobytes(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/secret_boxes/xsalsa20poly1305.rb:103
  def decrypt(nonce, ciphertext); end

  # pkg:gem/rbnacl#lib/rbnacl/secret_boxes/xsalsa20poly1305.rb:77
  def encrypt(nonce, message); end
  ...
  # @return [Integer] The number of bytes in a valid key
  #
  # pkg:gem/rbnacl#lib/rbnacl/secret_boxes/xsalsa20poly1305.rb:136
  def key_bytes; end
  ...
  # @return [Integer] The number of bytes in a valid nonce
  #
  # pkg:gem/rbnacl#lib/rbnacl/secret_boxes/xsalsa20poly1305.rb:122
  def nonce_bytes; end
  ...
  # @return [String] The decrypted message (BINARY encoded)
  #
  # pkg:gem/rbnacl#lib/rbnacl/secret_boxes/xsalsa20poly1305.rb:93
  def open(nonce, ciphertext); end
  ...
  # @return [Symbol] The primitive used
  #
  # pkg:gem/rbnacl#lib/rbnacl/secret_boxes/xsalsa20poly1305.rb:108
  def primitive; end
  ...
  class << self
    ...
    # @return [Integer] The number of bytes in a valid key
    #
    # pkg:gem/rbnacl#lib/rbnacl/secret_boxes/xsalsa20poly1305.rb:129
    def key_bytes; end
    ...
    # @return [Integer] The number of bytes in a valid nonce
    #
    # pkg:gem/rbnacl#lib/rbnacl/secret_boxes/xsalsa20poly1305.rb:115
    def nonce_bytes; end
...
#
# pkg:gem/rbnacl#lib/rbnacl/self_test.rb:11
module RbNaCl::SelfTest
  private

  # pkg:gem/rbnacl#lib/rbnacl/self_test.rb:31
  def box_common_test(box); end

  # pkg:gem/rbnacl#lib/rbnacl/self_test.rb:18
  def box_test; end

  # pkg:gem/rbnacl#lib/rbnacl/self_test.rb:51
  def digital_signature_test; end

  # pkg:gem/rbnacl#lib/rbnacl/self_test.rb:94
  def hmac_test(klass, tag); end

  # pkg:gem/rbnacl#lib/rbnacl/self_test.rb:26
  def secret_box_test; end

  # pkg:gem/rbnacl#lib/rbnacl/self_test.rb:87
  def sha256_test; end

  # pkg:gem/rbnacl#lib/rbnacl/self_test.rb:14
  def vector(name); end
...
# pkg:gem/rbnacl#lib/rbnacl/self_test.rb:8
class RbNaCl::SelfTestFailure < ::RbNaCl::CryptoError; end

# Serialization features shared across all "key-like" classes
#
# pkg:gem/rbnacl#lib/rbnacl/serializable.rb:6
module RbNaCl::Serializable
  # Inspect this key
  #
  # @return [String] a string representing this key
  #
  # pkg:gem/rbnacl#lib/rbnacl/serializable.rb:18
  def inspect; end

  # pkg:gem/rbnacl#lib/rbnacl/serializable.rb:7
  def to_s; end

  # pkg:gem/rbnacl#lib/rbnacl/serializable.rb:11
  def to_str; end
end

# pkg:gem/rbnacl#lib/rbnacl/signatures/ed25519.rb:5
module RbNaCl::Signatures; end

# The EdDSA signature system implemented using the Ed25519 elliptic curve
#
# pkg:gem/rbnacl#lib/rbnacl/signatures/ed25519.rb:7
module RbNaCl::Signatures::Ed25519
  extend ::RbNaCl::Sodium
  extend ::FFI::Library

  # pkg:gem/rbnacl#lib/rbnacl/signatures/ed25519.rb:15
  def crypto_sign_ed25519_bytes(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/signatures/ed25519.rb:13
  def crypto_sign_ed25519_publickeybytes(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/signatures/ed25519.rb:14
  def crypto_sign_ed25519_secretkeybytes(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/signatures/ed25519.rb:12
...
#
# pkg:gem/rbnacl#lib/rbnacl/signatures/ed25519/signing_key.rb:24
class RbNaCl::Signatures::Ed25519::SigningKey
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/signatures/ed25519/signing_key.rb:59
  def initialize(seed); end

  # pkg:gem/rbnacl#lib/rbnacl/signatures/ed25519/signing_key.rb:33
  def crypto_sign_ed25519(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/signatures/ed25519/signing_key.rb:37
  def crypto_sign_ed25519_seed_keypair(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/signatures/ed25519/signing_key.rb:41
  def crypto_sign_ed25519_sk_to_curve25519(*_arg0); end
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/signatures/ed25519/signing_key.rb:106
  ...
  # @return [Symbol] The primitive
  #
  # pkg:gem/rbnacl#lib/rbnacl/signatures/ed25519/signing_key.rb:113
  def primitive; end
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/signatures/ed25519/signing_key.rb:79
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/signatures/ed25519/signing_key.rb:88
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/signatures/ed25519/signing_key.rb:127
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/signatures/ed25519/signing_key.rb:98
  def to_bytes; end
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/signatures/ed25519/signing_key.rb:137
  def to_curve25519_private_key; end

  # pkg:gem/rbnacl#lib/rbnacl/signatures/ed25519/signing_key.rb:45
  def verify_key; end
  ...
  class << self
    ...
    #
    # pkg:gem/rbnacl#lib/rbnacl/signatures/ed25519/signing_key.rb:50
    def generate; end
    ...
    # @return [Integer] The number of bytes in a signature
    #
    # pkg:gem/rbnacl#lib/rbnacl/signatures/ed25519/signing_key.rb:120
    def signature_bytes; end

    # pkg:gem/rbnacl#lib/rbnacl/signatures/ed25519/signing_key.rb:41
    def to_private_key(*args); end
  end
end
...
#
# pkg:gem/rbnacl#lib/rbnacl/signatures/ed25519/verify_key.rb:13
class RbNaCl::Signatures::Ed25519::VerifyKey
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/signatures/ed25519/verify_key.rb:35
  def initialize(key); end

  # pkg:gem/rbnacl#lib/rbnacl/signatures/ed25519/verify_key.rb:22
  def crypto_sign_ed25519_open(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/signatures/ed25519/verify_key.rb:26
  def crypto_sign_ed25519_pk_to_curve25519(*_arg0); end

  # The crypto primitive this VerifyKey class uses for signatures
  #
  # @return [Symbol] The primitive
  #
  # pkg:gem/rbnacl#lib/rbnacl/signatures/ed25519/verify_key.rb:89
  def primitive; end
  ...
  # @return [Integer] The number of bytes in a signature
  #
  # pkg:gem/rbnacl#lib/rbnacl/signatures/ed25519/verify_key.rb:103
  def signature_bytes; end
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/signatures/ed25519/verify_key.rb:82
  def to_bytes; end
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/signatures/ed25519/verify_key.rb:113
  def to_curve25519_public_key; end
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/signatures/ed25519/verify_key.rb:51
  ...
  # @return [Boolean] was the signature authentic?
  #
  # pkg:gem/rbnacl#lib/rbnacl/signatures/ed25519/verify_key.rb:66
  ...
  class << self
    ...
    # @return [Integer] The number of bytes in a signature
    #
    # pkg:gem/rbnacl#lib/rbnacl/signatures/ed25519/verify_key.rb:96
    def signature_bytes; end

    # pkg:gem/rbnacl#lib/rbnacl/signatures/ed25519/verify_key.rb:26
    def to_public_key(*args); end
  end
end

# pkg:gem/rbnacl#lib/rbnacl.rb:101
...
#   active adversary.
#
# pkg:gem/rbnacl#lib/rbnacl/simple_box.rb:34
class RbNaCl::SimpleBox
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/simple_box.rb:43
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/simple_box.rb:80
  def box(message); end

  # pkg:gem/rbnacl#lib/rbnacl/simple_box.rb:101
  def decrypt(enciphered_message); end

  # pkg:gem/rbnacl#lib/rbnacl/simple_box.rb:85
  def encrypt(message); end

  # pkg:gem/rbnacl#lib/rbnacl/simple_box.rb:36
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/simple_box.rb:97
  ...
  # pkg:gem/rbnacl#lib/rbnacl/simple_box.rb:109
  def extract_nonce(bytes); end

  # pkg:gem/rbnacl#lib/rbnacl/simple_box.rb:105
  ...
  class << self
    ...
    # @return [SimpleBox] Ready for use
    #
    # pkg:gem/rbnacl#lib/rbnacl/simple_box.rb:68
    ...
    # @return [SimpleBox] Ready for use
    #
    # pkg:gem/rbnacl#lib/rbnacl/simple_box.rb:55
...
#
# pkg:gem/rbnacl#lib/rbnacl/sodium.rb:8
module RbNaCl::Sodium
  # pkg:gem/rbnacl#lib/rbnacl/sodium.rb:28
  def primitive; end

  # pkg:gem/rbnacl#lib/rbnacl/sodium.rb:32
  def sodium_constant(constant, name: T.unsafe(nil), fallback: T.unsafe(nil)); end

  # pkg:gem/rbnacl#lib/rbnacl/sodium.rb:47
  def sodium_function(name, function, arguments); end

  # pkg:gem/rbnacl#lib/rbnacl/sodium.rb:57
  def sodium_function_with_return_code(name, function, arguments); end

  # pkg:gem/rbnacl#lib/rbnacl/sodium.rb:20
  def sodium_primitive(primitive = T.unsafe(nil)); end

  # pkg:gem/rbnacl#lib/rbnacl/sodium.rb:14
  def sodium_type(type = T.unsafe(nil)); end

  class << self
    # pkg:gem/rbnacl#lib/rbnacl/sodium.rb:9
...
#
# pkg:gem/rbnacl#lib/rbnacl/sodium/version.rb:9
module RbNaCl::Sodium::Version
  extend ::RbNaCl::Sodium
  extend ::FFI::Library

  # pkg:gem/rbnacl#lib/rbnacl/sodium/version.rb:15
...
# pkg:gem/rbnacl#lib/rbnacl/sodium/version.rb:17
...
#
# pkg:gem/rbnacl#lib/rbnacl/test_vectors.rb:8
RbNaCl::TEST_VECTORS = T.let(T.unsafe(nil), Hash)

# Various utility functions
#
# pkg:gem/rbnacl#lib/rbnacl/util.rb:6
module RbNaCl::Util
  extend ::RbNaCl::Sodium
  extend ::FFI::Library

  # pkg:gem/rbnacl#lib/rbnacl/util.rb:9
  def crypto_verify_16(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/util.rb:10
  def crypto_verify_32(*_arg0); end

  # pkg:gem/rbnacl#lib/rbnacl/util.rb:11
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/util.rb:278
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/util.rb:141
  def check_hmac_key(string, description); end
  ...
  # @param description [String] Description of the string (used in the error)
  #
  # pkg:gem/rbnacl#lib/rbnacl/util.rb:83
  ...
  # @param description [String] Description of the string (used in the error)
  #
  # pkg:gem/rbnacl#lib/rbnacl/util.rb:111
  ...
  # @param string [#to_str] The input string
  #
  # pkg:gem/rbnacl#lib/rbnacl/util.rb:163
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/util.rb:287
  def hex2bin(hex); end
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/util.rb:37
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/util.rb:50
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/util.rb:249
  ...
  # @return [Boolean] Well, are they equal?
  #
  # pkg:gem/rbnacl#lib/rbnacl/util.rb:267
  def verify16!(one, two); end
  ...
  # @return [Boolean] Well, are they equal?
  #
  # pkg:gem/rbnacl#lib/rbnacl/util.rb:215
  ...
  # @return [Boolean] Well, are they equal?
  #
  # pkg:gem/rbnacl#lib/rbnacl/util.rb:233
  def verify32!(one, two); end
  ...
  # @return [Boolean] Well, are they equal?
  #
  # pkg:gem/rbnacl#lib/rbnacl/util.rb:181
  ...
  # @return [Boolean] Well, are they equal?
  #
  # pkg:gem/rbnacl#lib/rbnacl/util.rb:199
  def verify64!(one, two); end
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/util.rb:62
  ...
  #
  # pkg:gem/rbnacl#lib/rbnacl/util.rb:22
...
#
# pkg:gem/rbnacl#lib/rbnacl/version.rb:7
RbNaCl::VERSION = T.let(T.unsafe(nil), String)

# pkg:gem/rbnacl#lib/rbnacl.rb:102
